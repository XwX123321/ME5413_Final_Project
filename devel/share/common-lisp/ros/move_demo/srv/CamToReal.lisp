...
(cl:defmethod cl:initialize-instance :after ((m <CamToReal-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'CamToReal-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name move_demo-srv:<CamToReal-request> is deprecated: use move_demo-srv:CamToReal-request instead.")))

(cl:ensure-generic-function 'pixel_x-val :lambda-list '(m))
(cl:defmethod pixel_x-val ((m <CamToReal-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader move_demo-srv:pixel_x-val is deprecated.  Use move_demo-srv:pixel_x instead.")
  (pixel_x m))

(cl:ensure-generic-function 'pixel_y-val :lambda-list '(m))
(cl:defmethod pixel_y-val ((m <CamToReal-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader move_demo-srv:pixel_y-val is deprecated.  Use move_demo-srv:pixel_y instead.")
  (pixel_y m))
...
(cl:defmethod cl:initialize-instance :after ((m <CamToReal-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'CamToReal-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name move_demo-srv:<CamToReal-response> is deprecated: use move_demo-srv:CamToReal-response instead.")))

(cl:ensure-generic-function 'obj_x-val :lambda-list '(m))
(cl:defmethod obj_x-val ((m <CamToReal-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader move_demo-srv:obj_x-val is deprecated.  Use move_demo-srv:obj_x instead.")
  (obj_x m))

(cl:ensure-generic-function 'obj_y-val :lambda-list '(m))
(cl:defmethod obj_y-val ((m <CamToReal-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader move_demo-srv:obj_y-val is deprecated.  Use move_demo-srv:obj_y instead.")
  (obj_y m))

(cl:ensure-generic-function 'obj_z-val :lambda-list '(m))
(cl:defmethod obj_z-val ((m <CamToReal-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader move_demo-srv:obj_z-val is deprecated.  Use move_demo-srv:obj_z instead.")
  (obj_z m))
